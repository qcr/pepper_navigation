...
namespace TNT
{
  ...
  public:
    ...
    Subscript offset(Subscript i) const                 // 1-offset
    {
      ...
      BIASASSERT( A_.lbound() <= i);
      BIASASSERT( i<= dim_[0] + A_.lbound()-1);
#endif
      ...
      Subscript j2) : A_(A)
    {
      ...
      BIASASSERT( i1 <= i2 );
      BIASASSERT( j1 <= j2);
      BIASASSERT( A.lbound() <= i1);
      BIASASSERT( i2<= A.dim(A.lbound()) + A.lbound()-1);
      BIASASSERT( A.lbound() <= j1);
      BIASASSERT( j2<= A.dim(A.lbound()+1) + A.lbound()-1 );
#endif
    ...
    Region2D(Array2D &A, const Index1D &I, const Index1D &J) : A_(A)
    {
      ...
      BIASASSERT( J.lbound() <= J.ubound() );
      BIASASSERT( A.lbound() <= I.lbound());
      BIASASSERT( I.ubound()<= A.dim(A.lbound()) + A.lbound()-1);
      BIASASSERT( A.lbound() <= J.lbound());
      BIASASSERT( J.ubound() <= A.dim(A.lbound()+1) + A.lbound()-1 );
#endif
      ...
      Subscript j1, Subscript j2)
    {
      ...
      BIASASSERT( i1 <= i2 );
      BIASASSERT( j1 <= j2);
      BIASASSERT( A_.lbound() <= i1);
      BIASASSERT( i2<= dim_[0] + A_.lbound()-1);
      BIASASSERT( A_.lbound() <= j1);
      BIASASSERT( j2<= dim_[1] + A_.lbound()-1 );
#endif
      ...
      const Index1D &J)
    {
      ...
      BIASASSERT( I.lbound() <= I.ubound() );
      BIASASSERT( J.lbound() <= J.ubound() );
      BIASASSERT( A_.lbound() <= I.lbound());
      BIASASSERT( I.ubound()<= dim_[0] + A_.lbound()-1);
      BIASASSERT( A_.lbound() <= J.lbound());
      BIASASSERT( J.ubound() <= dim_[1] + A_.lbound()-1 );
#endif
    ...
    inline T & operator()(Subscript i, Subscript j)
    {
      ...
      BIASASSERT( A_.lbound() <= i);
      BIASASSERT( i<= dim_[0] + A_.lbound()-1);
      BIASASSERT( A_.lbound() <= j);
      BIASASSERT( j<= dim_[1] + A_.lbound()-1 );
#endif
    ...
    Region2D<Array2D> & operator=(const Region2D<Array2D> &R)
    {
      ...
      BIASASSERT(M == R.num_rows());
      BIASASSERT(N == R.num_cols());
  ...
  public:
    ...
    Subscript offset(Subscript i) const                 // 1-offset
    {
      ...
      BIASASSERT( i<= dim_[0] + TNT_BASE_OFFSET-1);
#endif
      ...
      Subscript j1, Subscript j2) : A_(A)
    {
      ...
      BIASASSERT( i2<= A.dim(TNT_BASE_OFFSET) + TNT_BASE_OFFSET-1);
      BIASASSERT( TNT_BASE_OFFSET <= j1);
      BIASASSERT( j2<= A.dim(TNT_BASE_OFFSET+1) + TNT_BASE_OFFSET-1 );
#endif
      ...
      : A_(A)
    {
      ...
      BIASASSERT( I.ubound()<= A.dim(TNT_BASE_OFFSET) + TNT_BASE_OFFSET-1);
      BIASASSERT( TNT_BASE_OFFSET <= J.lbound());
      BIASASSERT( J.ubound() <= A.dim(TNT_BASE_OFFSET+1) + TNT_BASE_OFFSET-1 );
#endif
      ...
      Subscript j1, Subscript j2)
    {
      ...
      BIASASSERT( j1 <= j2);
      BIASASSERT( TNT_BASE_OFFSET <= i1);
      BIASASSERT( i2<= dim_[0] + TNT_BASE_OFFSET-1);
      BIASASSERT( TNT_BASE_OFFSET <= j1);
      BIASASSERT( j2<= dim_[0] + TNT_BASE_OFFSET-1 );
#endif
      ...
      const Index1D &J)
    {
      ...
      BIASASSERT( J.lbound() <= J.ubound() );
      BIASASSERT( TNT_BASE_OFFSET <= I.lbound());
      BIASASSERT( I.ubound()<= dim_[0] + TNT_BASE_OFFSET-1);
      BIASASSERT( TNT_BASE_OFFSET <= J.lbound());
      BIASASSERT( J.ubound() <= dim_[1] + TNT_BASE_OFFSET-1 );
#endif
    ...
    inline const T & operator() (Subscript i, Subscript j) const
    {
      ...
      BIASASSERT( TNT_BASE_OFFSET <= i);
      BIASASSERT( i<= dim_[0] + TNT_BASE_OFFSET-1);
      BIASASSERT( TNT_BASE_OFFSET <= j);
      BIASASSERT( j<= dim_[1] + TNT_BASE_OFFSET-1 );
#endif
      return A_(i+offset_[0], j+offset_[1]);
    }
